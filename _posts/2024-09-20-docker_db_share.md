...
1번이 가장 깔끔하지만, 비용의 문제가 있고, 새로운 DB의 사용법을 익혀야 한다는 부담이 있습니다. 그것이 프로젝트의 참여자 모두에게 적용된다면 프로젝트의 진행 측면에서 큰 손실일 수 있습니다.
...
mysql -u root -p --(4)
password: 1111 --(5)
GRANT ALL PRIVILEGES ON *.* TO 'root'@'%' IDENTIFIED BY '1111'; --(6)
FLUSH PRIVILEGES; --(7)
